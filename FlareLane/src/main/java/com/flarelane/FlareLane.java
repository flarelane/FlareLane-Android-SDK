...
public class FlareLane {
    ...
    public static void setIsSubscribed(Context context, boolean isSubscribed, IsSubscribedHandler handler) {
        try {
    ...
    public static void subscribe(Context context, boolean fallbackToSettings, IsSubscribedHandler handler) {
        try {
    ...
    public static void unsubscribe(Context context, IsSubscribedHandler handler) {
    ...
    protected static void updatePushToken(Context context, UpdatePushTokenHandler handler) {
        try {
            String projectId = com.flarelane.BaseSharedPreferences.getProjectId(context, false);
